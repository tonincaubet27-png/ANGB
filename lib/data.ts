...
const MOCK_GOALIES: Goalie[] = [
  // ── Fondateurs ANGB ───────────────────────────────────────────────────────
  { id:'f1', name:'Tonin Caubet',         club:'Montpellier HC',      division:'D2',             region:'Occitanie',          bio_note:'Président fondateur ANGB · Gardien · Rouen Dragons (Magnus 2022-24) · Valenciennes (D2 2024-26) · International France U16, U18, U20', is_active:true, created_at:'2026-01-01' },
  { id:'f2', name:'Pacôme Courtoison',    club:undefined,             division:undefined,        region:undefined,            bio_note:'Fondateur ANGB', is_active:true, created_at:'2026-01-01' },
  { id:'f3', name:'Steven Catelin',       club:undefined,             division:undefined,        region:undefined,            bio_note:'Fondateur ANGB', is_active:true, created_at:'2026-01-01' },
  { id:'f4', name:'Flo Gourdin',          club:undefined,             division:undefined,        region:undefined,            bio_note:'Fondateur ANGB', is_active:true, created_at:'2026-01-01' },
  { id:'f5', name:'Jean-JP Fontaine',     club:undefined,             division:undefined,        region:undefined,            bio_note:'Fondateur ANGB', is_active:true, created_at:'2026-01-01' },
  { id:'f6', name:'Adrien Vazzaz',        club:undefined,             division:undefined,        region:undefined,            bio_note:'Fondateur ANGB', is_active:true, created_at:'2026-01-01' },
  // ── Autres gardiens ───────────────────────────────────────────────────────
